...
## [1] bookdown_0.30   miniUI_0.1.1.1  rmarkdown_2.18 
## [4] tools_4.2.1     shiny_1.7.2     htmltools_0.5.3
## [7] knitr_1.40
\end{verbatim}
...
  我们以尽在第 \ref{usage} 节中提到了 \texttt{rmd\_files}，并且你可以在 \texttt{\_bookdown.yml}\index{\_bookdown.yml} 中为书籍配置更多（可选的）设置。\footnote{对于 \protect\hyperlink{bs4-book}{\texttt{bs4\_book()}} 格式，\texttt{edit}、\texttt{history} 和 \texttt{view} 字段不会起作用，可以使用输出函数的 \protect\hyperlink{specifying-the-repository}{repo} 参数来指定类似的配置。}:
...
\hypertarget{ux53efux9009ux66f4ux65b0ux7ad9ux70b9}{%
...
\DocumentationTok{\#\#  pdfTeX 3.141592653{-}2.6{-}1.40.24 (TeX Live 2022)}
\DocumentationTok{\#\#  kpathsea version 6.3.4}
\DocumentationTok{\#\#  Copyright 2022 Han The Thanh (pdfTeX) et al.}
